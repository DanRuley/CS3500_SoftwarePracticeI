...
namespace TankWars
{
    ...
    public class Vector2D
    {
        ...
        /// <summary>
        /// Compare two points, point l is said to be less than point r if BOTH the x and y values are less than the others point's
        /// </summary>
        /// <param name="l"></param>
        /// <param name="r"></param>
        /// <returns></returns>
        ...
        {
            return l.GetY() < r.GetY() && l.GetX() < r.GetY();
        }

        /// <summary>
        /// Compare two points, point l is said to be greater than point r if BOTH the x and y values are greater than the other point's
        /// </summary>
        /// <param name="l"></param>
        /// <param name="r"></param>
        /// <returns></returns>
